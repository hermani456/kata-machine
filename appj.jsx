const appj = () => {
    return (
        <div id="card" className="w-[17rem] h-40 cursor-pointer hover:bg-[#ffbc00] transition-colors rounded-lg">
            <div className="pt-6 px-5 space-y-1">
                ...
                <h2 className="font-bold text-sm">Collections</h2>
                <p className="text-[11px]">
                    A Collection's fileds define the structure of the items
                    within it.
                </p>
            </div>
        </div>
